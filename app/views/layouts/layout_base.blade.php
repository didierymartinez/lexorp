      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu forAnimate" role="menu">
            <li><a href="{{URL::to('libros')}}"><span style="font-size:16px;" class="glyphicon glyphicon-book"></span> Catálogo</a></li>
            <li><a href="{{URL::to('usuariosbiblioteca')}}"><span style="font-size:16px;" class="glyphicon glyphicon-user"></span> Usuarios</a></li>          
          </ul>
        </li>
        
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Inventario <span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-barcode"></span></a>
          <ul class="dropdown-menu forAnimate" role="menu">
            <li><a href="{{URL::to('inventario')}}"><span style="font-size:16px;" class="glyphicon glyphicon-book"></span> Libros</a></li>
            <li><a href="{{URL::to('busqueda')}}"><span style="font-size:16px;" class="glyphicon glyphicon-search"></span> Busqueda</a></li>
            <li><a href="{{URL::to('movimientos')}}"><span style="font-size:16px;" class="glyphicon glyphicon-transfer"></span> Movimientos</a></li>            
          </ul>
        </li>
